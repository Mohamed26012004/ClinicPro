...
public class SelectOnePlanificationClientRequest extends ClientRequest<PlanificationExamen, PlanificationExamens> {

    public SelectOnePlanificationClientRequest(NetworkConfig networkConfig, int myBirthDate, Request request, PlanificationExamen info, byte[] bytes) throws IOException {
