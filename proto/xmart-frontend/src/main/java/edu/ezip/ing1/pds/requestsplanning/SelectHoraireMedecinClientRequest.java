...
public class SelectHoraireMedecinClientRequest extends ClientRequest<Medecin, Horaires> {

    public SelectHoraireMedecinClientRequest(NetworkConfig networkConfig, int myBirthDate, Request request, Medecin info, byte[] bytes) throws IOException {
