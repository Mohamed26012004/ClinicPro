...
public class SelectPlanificationWithNameClientRequest extends ClientRequest<PlanificationExamen, PlanificationWithNames> {


    public SelectPlanificationWithNameClientRequest(NetworkConfig networkConfig, int myBirthDate, Request request, PlanificationExamen info, byte[] bytes) throws IOException {
