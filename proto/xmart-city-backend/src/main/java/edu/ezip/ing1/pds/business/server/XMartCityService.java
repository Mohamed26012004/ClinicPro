...
public class XMartCityService {
    ...
    private enum Queries {
        ...
        UPDATE_PAIEMENT("UPDATE paiement SET montant = ?, dateFacture = ?, moyenDePaiement = ? WHERE idPaiement = ?"),
        DELETE_PAIEMENT("DELETE FROM paiement WHERE montant = ? AND dateFacture = ? AND moyenDePaiement = ?"),
